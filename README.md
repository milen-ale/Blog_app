...
# 📖 [Blog_App] <a name="Ruby on Rails Blog_App project"></a>
...
<details>
  ...
  <ul>
    <li><a href="https://expressjs.com/">rubyonrails</a></li>
  </ul>
</details>
...
sh
  cd my-folder
 https://github.com/milen-ale/Blog_app.git
...
To run tests, run the following command:
 sh
  bin/rails test test/models/user_spec.rb
